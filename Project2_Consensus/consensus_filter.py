...
class Environment:
	...
	def __init__(self, target_function, communication_radius = None, max_neighbors = None):
...
class Simulate:
	...
	def __init__(self):
		...
		self.environment = Environment(lambda t : np.array([50.0, 50.0]), communication_radius = 50.0)
