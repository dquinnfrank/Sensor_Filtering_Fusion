...
class Simulate:
	...
	#
	# default_consensus_method : string
	def __init__(self, max_range, num_nodes = 10, communication_radius = 1.7, default_consensus_method = "Max Degree", target_position_name = "Stationary Center", target_reading_name = "Constant 50"):
		...
		if target_position_name == "Stationary Center":
		...
		if target_reading_name == "Constant 50":
		...
		self.environment = Environment(target_position_function, target_reading_function, communication_radius = 1.7)
...
if __name__ == "__main__":
	...
	sim = Simulate(3, default_consensus_method = "Max Degree")
